...
Documentation                                   This Robot Framework automation test suite allows users to navigate to
...                                             a CRM website's homepage, log in and log out, and add a new customer

#Run the script:
#robot -d results Tests/Crm.robot               To run all tests in a file.
#robot -d results -i Contacts Tests/Crm.robot   To run tagged tests in a file.
